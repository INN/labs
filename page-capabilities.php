			...
			<div class="inner content">
				...
				<div class="flex-grid">
					...
					<div>
						...
						<p>Have you discovered a great dataset and want to really make it impactful? Our team includes experts in data visualization and news application design, and we’d love to work with you to present your data in beautiful and highly effective ways.</p>
					</div>
				</div>
